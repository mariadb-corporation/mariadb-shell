...
DESCRIPTION
      ...
      behavior in the event of a loss of quorum on the only reachable target
      Cluster partition. By default, Router will disconnect all existing
      connections and refuse new ones, but that can be configured using the
      following options:
      ...
      ATTENTION: Setting this option to a value other than the default may have
                 ...
                 InnoDB ClusterSet are broken since the data read can be stale;
