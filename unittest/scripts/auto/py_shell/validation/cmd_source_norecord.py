...
ERROR: 1064 (42000) at line 1: You have an error in your SQL syntax; check the manual that corresponds to your <<<sandbox.vendor()>>> server version for the right syntax to use near '\source --js cmd_source_test.js' at line 1
