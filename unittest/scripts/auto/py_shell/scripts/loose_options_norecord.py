...
testutil.call_mysqlsh(["--loose-whatever", "--py", "-e", "print('done')"], "", ["MYSQLSH_TERM_COLOR_MODE=nocolor"])
EXPECT_STDOUT_CONTAINS("WARNING: unknown option: --loose-whatever")
WIPE_OUTPUT()

#@<> Warnins on unknown loose options with --quiet-start=1
testutil.call_mysqlsh(["--quiet-start=1", "--loose-whatever", "--py", "-e", "print('done')"], "", ["MYSQLSH_TERM_COLOR_MODE=nocolor"])
EXPECT_STDOUT_CONTAINS("WARNING: unknown option: --loose-whatever")
WIPE_OUTPUT()

#@<> No warnins on unknown loose options with --quiet-start=2
testutil.call_mysqlsh(["--quiet-start=2", "--loose-whatever", "--py", "-e", "print('done')"], "", ["MYSQLSH_TERM_COLOR_MODE=nocolor"])
EXPECT_STDOUT_NOT_CONTAINS("WARNING: unknown option: --loose-whatever")
WIPE_OUTPUT()

#@<> Existing options can be prefixed with --loose
testutil.call_mysqlsh(["--loose-quiet-start=1", "--loose-whatever", "--py", "-e", "print('done')"], "", ["MYSQLSH_TERM_COLOR_MODE=nocolor"])
...
testutil.call_mysqlsh([f"--loose-whatever={__mysqluripwd}", "--py", "-e", "print(session)"], "", ["MYSQLSH_TERM_COLOR_MODE=nocolor"])
...
""")
testutil.call_mysqlsh(["--defaults-file=my_options.cnf", "--py", "-e", "print('done')"], "", ["MYSQLSH_TERM_COLOR_MODE=nocolor"])
