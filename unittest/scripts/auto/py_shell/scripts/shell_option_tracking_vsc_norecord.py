...
testutil.set_execution_context(".vsc")
...
#@<> WL16659-FR2.2/FR4.2 in relation to FR1.1
...
#@<> WL16659-FR2.1
# A new command line argument must enable defining a custom execution context,
# to be considered in option tracking reporting
testutil.call_mysqlsh([__sandbox_uri1, '--execution-context=.vsc', '-e', 'select 1'])
expected_variables['option_tracker_usage:Mysql Shell for VS Code'] += 1
verify_variables(expected_variables, main_session)

with open('sample.sql', 'w') as file:
    file.write(f"\\connect {__sandbox_uri1}")
testutil.call_mysqlsh(['--interactive', '--execution-context=.vsc', '-f', 'sample.sql'])
...
#@<> WL16659-FR2.2/FR4.2 in relation to FR1.2
...
#@<> WL16659-FR2.2/FR4.2 in relation to FR1.3
...
#@<> WL16659-FR4.3 in relation to FR1.4
...
#@<> WL16659-FR4.3 in relation to FR1.5 {__version_num < __mysh_version_num}
