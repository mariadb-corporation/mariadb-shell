...
if (__version_num < 80011) {
EXPECT_OUTPUT_CONTAINS_MULTILINE(`WARNING: An error occurred when trying to catch up with cluster transactions and instance '${hostname}:${__mysql_sandbox_port2}' might have been left in an inconsistent state that will lead to errors if it is reused.
