...
function(CHECK_CXX_STD)
  IF(MSVC)
    ...
    IF(CXX_STD STREQUAL "23")
      SET(CXX_STD_FLAG "${CXX_STD_FLAG}preview")
    ENDIF()
  ELSE()
    SET(CXX_STD_FLAG "-std=c++${CXX_STD}")
  ENDIF()
...
if(CMAKE_COMPILER_IS_GNUCXX OR CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  ...
  if(CMAKE_COMPILER_IS_GNUCXX)
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wlogical-op -Wno-error=type-limits -Wno-error=free-nonheap-object")
  else()
